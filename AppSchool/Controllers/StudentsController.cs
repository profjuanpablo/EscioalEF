...
namespace AppSchool.Controllers
{
    ...
    {
        private readonly AppSchoolContext _context;

        public StudentsController(AppSchoolContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppSchoolContext.Student'  is null.");
            }
            var student = await _context.Student.FindAsync(id);
            if (student != null)
            {
